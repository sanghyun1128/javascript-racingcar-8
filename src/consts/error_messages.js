...
const ERROR_MESSAGES = {
  ...
  MIN_PARTICIPANT: `참가자는 ${LIMIT_VALUES.MIN_PARTICIPANT}명 이상 이어야 합니다.`,
  MAX_PARTICIPANT: `참가자는 ${LIMIT_VALUES.MIN_PARTICIPANT}명을 넘으면 안됩니다.`,
  MIN_ROUND: `라운드의 수는 ${LIMIT_VALUES.MIN_NUM_OF_ROUND} 이상 이어야 합니다.`,
  MAX_ROUND: `라운드의 수는 ${LIMIT_VALUES.MAX_NUM_OF_ROUND}을 넘으면 안됩니다.`,
